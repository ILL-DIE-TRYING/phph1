<?php
/**
* Method file for hmyv2_protocolVersion() in the phph1.php class file
*/
		...
		<div id="infoContent" class="infoContent">
			...
			<ul class="infoObjects" >
				<li class="infoObjectNoBul">
					<div>
						<p>Gets the current network protocol version.</p>
						<p>There may be more information in the <a href="./doc/classes/phph1.html#method_hmyv2_protocolVersion">PHPH1 Class Documentation</a>.</p>
					</div>
				</li>
			</ul>
