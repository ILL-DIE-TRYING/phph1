...
$hmyv2_getElectedValidatorAddresses_data = $phph1->hmyv2_getElectedValidatorAddresses();
...
if($validinput == 1){
	...
	echo "<h2>HARMONY ELECTED VALIDATOR ADDRESSES ARRAY</h2>";
	if(isset($phph1->lastjson)){
		echo "<p style='color:green;'>This JSON RPC Request:<br />".$phph1->lastjson."</p>";
	}
	echo "<pre>";
	print_r($hmyv2_getElectedValidatorAddresses_data);
	echo "</pre>";
