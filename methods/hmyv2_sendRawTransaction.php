<?php
/**
* Method file for hmyv2_sendRawTransaction() in the phph1.php class file
*/
...
if($phph1->chk_dorequest()){
	...
	*/
	if($phph1->val_sendRawTransaction($transhex)){
		$hmyv2_data = $phph1->hmyv2_sendRawTransaction($transhex);
	}
			...
			<div id="infoContent" class="infoContent">
				...
				<ul class="infoObjects" >
					<li class="infoObjectNoBul">
						<div>
							<p>Sends raw transaction using the hex representation of signed transaction.</p>
				...
				<ul class="infoObjects" >
					...
					<div class="iodefWrap">Hex representation of signed transaction</div></li>
	...
	<div class="form_container">
		<div id="formcontent">
			...
			<div class="row">
				...
				<input type="hidden" id="method" name="method" value="hmyv2_sendRawTransaction" />
