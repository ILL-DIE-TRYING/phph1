<?php
/**
* Method file for hmyv2_getTransactionByBlockNumberAndIndex() in the phph1.php class file
*/
...
if($phph1->chk_dorequest()){
	...
	*/
	if($phph1->val_getTransactionByBlockNumberAndIndex($blocknum,$txindex)){
		$validinput = 1;
		$hmyv2_data = $phph1->hmyv2_getTransactionByBlockNumberAndIndex($blocknum,$txindex);
	}
...
?>
			...
			<div id="infoContent" class="infoContent">
				...
				<ul class="infoObjects" >
					<li class="infoObjectNoBul">
						<div>
							<p>Gets transaction details using block number and transaction index.</p>
							<p>There may be more information in the <a href="./doc/classes/phph1.html#method_hmyv2_getTransactionByBlockNumberAndIndex">PHPH1 Class Documentation</a>.</p>
						</div>
					</li>
				</ul>
	...
	<div class="form_container">
		<div id="formcontent">
			<form action="/?method=hmyv2_getTransactionByBlockNumberAndIndex" method="post">
				<div class="row">
					<div class="col-25">
