...
$hmyv2_getPendingCXReceipts_data = $phph1->hmyv2_getPendingCXReceipts();
...
if($validinput == 1){
	...
	echo "<h2>PENDING CROSS SHARD TRANSACTION RECEIPTS ARRAY</h2>";
	if(isset($phph1->lastjson)){
		echo "<p style='color:green;'>This JSON RPC Request:<br />".$phph1->lastjson."</p>";
	}
	echo "<pre>";
	print_r($hmyv2_getPendingCXReceipts_data);
	echo "</pre>";
