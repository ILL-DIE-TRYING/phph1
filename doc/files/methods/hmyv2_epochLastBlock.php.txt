<?php
/**
* Method file for hmyv2_epochLastBlock() in the phph1.php class file
*/
...
if($phph1->chk_dorequest()){
	...
	*/
	if($phph1->val_epochLastBlock($epoch)){
		$hmyv2_data = $phph1->hmyv2_epochLastBlock($epoch);
	}
			...
			<div id="infoContent" class="infoContent">
				...
				<ul class="infoObjects" >
					<li class="infoObjectNoBul">
						<div>
							<p>Gets the last block at the specified epoch.</p>
							<p>There may be more information in the <a href="./doc/classes/phph1.html#method_hmyv2_epochLastBlock">PHPH1 Class Documentation</a>.</p>
						</div>
					</li>
				</ul>
				...
				<ul class="infoObjects">
					...
					<li class="infoObjectNoBul"><div class="ioobjectWrap"><span>Number</span>:</div> 
					<div class="iodefWrap">Last block number of given epoch</div></li>
