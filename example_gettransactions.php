...
*/
if(isset($_GET['oneaddr']) && $phph1->chkoneaddr($_GET['oneaddr']) && isset($_GET['do']) && $_GET['do'] == 1){
	$validinput = 1;
...
if(isset($_GET['oneaddr']) && $phph1_boothandle->chkoneaddr($_GET['oneaddr']) && isset($_GET['do']) && $_GET['do'] == 1){
	$validinput = 1;
...
if($validinput == 1){
	...
	*/
	...
	if($phph1->val_getTransactionsHistory($oneaddr,$pagenum,$pagesize,$fulltx,$txtype,$order)){
		...
		$validinput = 0;
		echo "INVALID INPUT: ".$phph1->val_getTransactionsHistory($oneaddr,$pagenum,$pagesize,$fulltx,$txtype,$order);
	}
}
?>
