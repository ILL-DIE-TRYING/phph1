...
<div id="hiddenSticky">
	<div id="topbar">
		<div class='logodiv'><img src="img/PHPH1_LOGO_2022-2.svg" style="max-width:70px;" alt="PHPH1 elephant logo" /></div>
	</div>
	<div id="navbar">
		<ul class="dropdownUL" >
			<li class="dropdownLI"><a href="./" title="Return To Homepage">Home</a></li>
			<li class="mdropdown">
				<a class="menudropbtn" href="javascript:void(0)" title="Main Menu"><img src="img/cheeseburger.svg" style="height:12px;margin:2px 0px 0px 0px;padding:0px;" alt="Menu"/></a>
				<div class="mdropdown-content">
					<div id="LoadMenuDropdown" class="mdropdown-list">
						...
						<a href="https://talk.harmony.one/t/php-class-api-requests-for-scripting-languages-and-harmony-node-api-explorer/11306" id="grantBtn" title="Bounty Information" target="_blank">Bounty Info</a>
